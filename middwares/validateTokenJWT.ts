...
export const validateTokenJWT = (handler: NextApiHandler) => (
    ...
    try {
        ...
        //Antes de executar requisição passada, o navegador faz um método "OPTIONS", para saber se aquele metodo 
        //com o dados que passamos é válido. E só se for válido ele faz a requisição real.
